...
public class WorkoutSelector extends AppCompatActivity implements TrainerAdapter.ItemClickListener {
    ...
    public void onItemClick(View view, int position) {
        ...
        workout.add( new WorkoutPrf("Spring", 0,0,1,2, 2, WorkoutPrf.WEIGHT_TBL ) );
        workout.add( new WorkoutPrf("Weight", 0,0,2,3, 3, WorkoutPrf.SPRING_TBL ) );
        workout.add( new WorkoutPrf("Weight", 0,0,3,4, 4, WorkoutPrf.INV_SPRING_TBL ) );
